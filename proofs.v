...
Proof.
  intros. unfold decriptaNumero. rewrite -> H6. unfold encriptaNumero. rewrite -> pot_pot.
  rewrite -> aux2. rewrite <- H1. rewrite <- potencia_mult.
  - rewrite -> mod_dist.  rewrite <- H1 in H4. rewrite -> pow_n_1.  rewrite -> mult_comm.
    rewrite -> mod__. apply dividePred2 in H4. rewrite <- H2 in H4. rewrite <- exists_multiple2 in H4. 
Admitted.
